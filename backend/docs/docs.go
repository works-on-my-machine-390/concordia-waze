...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/courses/sync": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "calendar id, default to primary",
                        "name": "calendar_id",
                        "in": "query"
                    }
                ],
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/domain.CourseItem"
                            }
                        }
                    },
                    "401": {
        ...
        "/users/{userId}/courses/{title}/classes": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/users/{userId}/courses/{title}/classes/{classId}": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
